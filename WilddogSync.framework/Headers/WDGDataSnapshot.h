...
/**
 *  如果这个 WDGDataSnapshot 有任何子节点返回YES，否则NO。
 *
 *  @return 如果这个 WDGDataSnapshot 有任何子节点返回YES
 */
- (BOOL)hasChildren;
